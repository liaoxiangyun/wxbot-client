...
def main(into_path, out_path, file_name):

    # print("into_path= "+into_path)
    # print("out_path= "+out_path)
    # print("file_name= "+file_name)
    dat_list = Dat_files(into_path, file_name)  # 把路径文件夹下的dat文件以列表呈现
    # print(dat_list)
    lens = len(dat_list)
    if lens == 0:
        print('没有dat文件')
    ...
    for dat_file in dat_list:  # 逐步读取文件
        ...
        # print('正在处理微信图片--->{}%'.format(value))


def Dat_files(file_dir, file_name):
    """
    ...
    for files in os.listdir(file_dir):
        sp = os.path.splitext(files)
        if sp[1] == '.dat' and files == file_name:
            dat.append(files)
    return dat
...
params = sys.argv[1].strip()
list = params.split("###")
# print(list)
# const wxDir = "C:\\Users\\liaoxy\\Documents\\WeChat Files\\"
wxDir = r'C:\Users\liaoxy\Documents\WeChat Files'
into_path = r'D:\Projects\2022-11\DatToPng\image'  # 微信image文件路径
out_path = r"D:\temp\images"
